...
+-------------------------------------------------------------+          |  System Report on sys-monitor |<--------------------------
                              ...
                              v                                          +-----------+-------------------+                          |
+-------------------------------------------------------------+                      |                                    +---------+-------------------------------------+
|                      parse_report.py                        |<---------------------+                                    |   daily_system_health.yml on debblue          |
|  (Dispatch logic: selects parser module based on report)    |                                                           |   (checks all vms, copies logs to sys-monitor |
+-------------------------------------------------------------+                                                           +-----------------------------------------------+
                                 |
          +----------------------+-------------------+-------------------+-------------------+
          |                      |                   |                   |                   |                   
